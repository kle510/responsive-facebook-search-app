...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            //fm.beginTransaction().replace(R.id.content_frame, new FavoritesFragment()).commit();
    ...
    public void sendMessage(View view) {
        ...
        if (message.isEmpty()) {
            ...
            String userURL = "http://sample-env-2.ex8irm6ngz.us-west-2.elasticbeanstalk.com/?keyword="+message+"&tabName=user";
            String pageURL = "http://sample-env-2.ex8irm6ngz.us-west-2.elasticbeanstalk.com/?keyword="+message+"&tabName=page";

            String eventURL = "http://sample-env-2.ex8irm6ngz.us-west-2.elasticbeanstalk.com/?keyword="+message+"&tabName=event";
            String placeURL = "http://sample-env-2.ex8irm6ngz.us-west-2.elasticbeanstalk.com/?keyword="+message+"&tabName=place";
            String groupURL = "http://sample-env-2.ex8irm6ngz.us-west-2.elasticbeanstalk.com/?keyword="+message+"&tabName=group";
